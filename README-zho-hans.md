...
测试环境：
- Windows 7 SP1 / Windows Server 2008 R2 SP1 (Build 7601.17514) （含 KB3125574）
...
- 从 Go 1.27 版本起，Windows 7 / Windows Server 2008 R2 的操作系统基准要求更新为：
  - **安装所有在 2016 年 4 月之前通过 Windows Update 发布的更新；**
  - **或者安装 KB3020369（至少为 2015 年 4 月版）+ KB3125574 补丁包。**
  - 此次系统要求的变更旨在提升安全性并实现 API 现代化。为了获得更好的安全性和系统功能，**仍建议安装绝大部分更新**，例如 SHA-2 签名支持更新以及针对“永恒之蓝”（EternalBlue）漏洞的修复补丁。
...
- 该 SDK 能否在 Windows 7 上进行编译作业： **可行，实际上取决于运行编译时的系统环境**
